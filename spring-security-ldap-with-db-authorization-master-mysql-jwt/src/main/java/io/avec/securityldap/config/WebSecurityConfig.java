...
import io.avec.securityldap.filter.JwtRequestFilter;
...
/*
	...
	*/		
	    	httpSecurity.csrf().disable().
			authorizeHttpRequests()
			.requestMatchers("/mysite/home/normalUser/**").hasRole("USER")
			.requestMatchers("/mysite/home/adminUser/**").hasRole("ADMIN1")
			//.requestMatchers("/actuator/**").hasRole("SUPERADMIN")
			.requestMatchers("/actuator/**").hasRole("SUPERADMIN")
